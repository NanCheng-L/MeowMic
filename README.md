...
基于 WASAPI 实时音频处理，支持 RNNoise + DeepFilterNet3 降噪模型，开箱即用。
...
> 🍵 如果 MeowMic 对你有帮助，欢迎[请作者喝杯奶茶~](https://afdian.com/a/NanCheng-L)
...
但你必须：
- **开源修改后的代码**：如果你修改并分发本软件，修改后的代码必须以相同协议（GPL-3.0）开源
- **保留版权声明**：在所有副本中保留原始版权声明和许可证
- **标注修改**：对代码进行修改时，需在修改的文件中添加显著说明
- **包含许可证**：分发时需附带完整的 GPL-3.0 许可证副本

简单来说：你可以免费使用，但不能闭源修改后拿去卖。
